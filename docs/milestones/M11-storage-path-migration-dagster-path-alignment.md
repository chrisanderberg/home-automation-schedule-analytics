# Milestone 11 - Storage path migration + Dagster path alignment (`data/data.sqlite` and `data/snapshots`)

## Canonical scope
This file is canonical for Milestone 11 execution details.

## Objective
- Storage path migration + Dagster path alignment (`data/data.sqlite` and `data/snapshots`)
