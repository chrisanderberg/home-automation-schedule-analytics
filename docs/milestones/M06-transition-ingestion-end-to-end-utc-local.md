# Milestone 06 - Transition ingestion end-to-end (UTC + Local)

## Canonical scope
This file is canonical for Milestone 06 execution details.

## Objective
- Transition ingestion end-to-end (UTC + Local)
