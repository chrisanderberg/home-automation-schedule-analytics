# Milestone 03 - UTC and Local clock bucketing + interval splitting

## Canonical scope
This file is canonical for Milestone 03 execution details.

## Objective
- UTC and Local clock bucketing + interval splitting
